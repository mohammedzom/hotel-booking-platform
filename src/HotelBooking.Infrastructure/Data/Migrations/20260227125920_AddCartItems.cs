        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartItems_hotel_room_types_HotelRoomTypeId",
                        column: x => x.HotelRoomTypeId,
                        principalTable: "hotel_room_types",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CartItems_hotels_HotelId",
                        column: x => x.HotelId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_HotelId",
                table: "CartItems",
                column: "HotelId");

            migrationBuilder.CreateIndex(
                name: "IX_CartItems_HotelRoomTypeId",
                table: "CartItems",
                column: "HotelRoomTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_CartItems_User_RoomType_Dates",
                table: "CartItems",
                columns: new[] { "UserId", "HotelRoomTypeId", "CheckIn", "CheckOut" },
                unique: true);
